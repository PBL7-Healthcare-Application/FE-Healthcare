...
import { Button, Card, DatePicker, Form, Input, Modal, Space, Table, Upload } from "antd";
      ...
      <div className="certificate">
        {
          type === "DOCTOR" && (
            <div style={{ width: '100%', display: 'flex', justifyContent: 'flex-end', marginBottom: 10 }}>
              <Button className="certificate-button" onClick={() => setIsAdd(true)}>Add Education</Button>
            </div>
          )
        }
        <Table
