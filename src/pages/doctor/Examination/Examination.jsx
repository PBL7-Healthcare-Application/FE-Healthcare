            ...
            <div className="exam_left">
                ...
                <div className="exam_left-content exam_left-search">
                    <div className="exam_left-content__infor">
                        <Image fallback={person} width={110} style={{ borderRadius: "50%" }} preview={false} />
                        <div className="exam_left-content__textArea">
                            <span className="exam_left-content__text">Bui Van Huy</span>
                            <span className="exam_left-content__text" style={{ fontSize: 18, fontWeight: 400 }}>0935350632</span>
                        </div>
                    </div>
                    <div className="exam_left-history">
                        <span className="exam_left-content__text" style={{ fontSize: 20, fontWeight: 500 }}>Medical History</span>
                    ...
                    <div className="exam_left-history__button">
                        <Button className="Schedule-content__left-button" style={{ width: '120px' }}  >Reschedule</Button>
            ...
            <div className="exam_right">
                ...
                <Form style={{ marginTop: 20 }}>
                    <div className="exam_right-vital">
                        <span className="exam_left-content__text" style={{ fontSize: 18, fontWeight: 500 }}>Vitals</span>
                        <div style={{ display: 'flex', justifyContent: 'space-between', width: '100%', gap: 20, marginTop: 20 }}>
                    ...
                    <div className="exam_right-vital" style={{ marginTop: 30 }}>
                        <span className="exam_left-content__text" style={{ fontSize: 18, fontWeight: 500 }}>Diseases</span>
                        <Form.Item style={{ marginTop: 20 }}>
                            <TextArea style={{ height: 200, fontSize: 16 }} placeholder="Enter patient's diseases ..." />
                        </Form.Item>
                    </div>
                    <div style={{ width: '100%', marginTop: 40, display: 'flex', justifyContent: 'flex-end' }}>
                        <Button className="Schedule-content__left-button" style={{ width: '120px' }}  >Save</Button>
                    </div>
                </Form>
            </div>
        </div>
