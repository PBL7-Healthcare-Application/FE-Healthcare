...
import {
  getDoctorDetail,
  getDoctorRating,
} from "../../stores/search-doctor/SearchThunk";
import CustomSkeleton from "../../components/customSkeleton/CustomSkeleton";
const DetailDoctor = () => {
  const { doctorDetail, schedule, listRate, tableOfrate, loading } =
  ...
  useEffect(() => {
    if (doctorDetail === null) {
      ...
      // console.log("doctorDetail", location);
    }
  }, [doctorDetail]);
            ...
            >
              <div className="detailDr-content__right-appointment--box">
                <div className="detailDr-content__right-appointment--box__type">
                  ...
                  >
                    VND {doctorDetail?.price && doctorDetail?.price.toLocaleString('vi-VN')}
                  </Typography>
                </div>
              </div>
            </Radio.Group>
