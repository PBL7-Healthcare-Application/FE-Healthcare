...
import { Button, Image, Radio, Slider, Table } from "antd"
import "./HealthTool.scss"
import bmrImg from "../../assets/images/BMR.webp"
import { useState } from "react"
import { activities } from "../../helpers/BMI";
...
function BMR() {
    ...
    const columns = [
        {
            title: <span className="health-font" style={{ fontSize: 16, fontWeight: 500, marginTop: 40, marginBottom: 20 }}>Activity Level</span>,
            dataIndex: "level",
            align: "center",
            className: "first_coloum",
            width: "50%",
        },

        {
            title: <span className="health-font" style={{ fontSize: 16, fontWeight: 500, marginTop: 40, marginBottom: 20 }}>Calories</span>,
            dataIndex: "calo",
            align: "center",
            width: "20%",
        },
        ...
        <div className="health" style={{ height: 'fit-content', marginBottom: 50 }}>
            <div className="health" style={{ backgroundColor: '#e3f0ff' }}>
                <div className="health-box health-box-header">
                    <div className="health-box-textArea">
                        <span className="health-font" style={{ fontWeight: 600, fontSize: 30, color: "#185fa0" }}>BMR Caculator Online</span>
                        <span className="health-font" style={{ fontSize: 17 }}>Basal Metabolic Rate (BMR) measures the calories needed to perform your body's most basic (basal) functions, like breathing, circulation, and cell production.</span>
                    </div>
                    <Image src={bmrImg} preview={false} width={150} />
            ...
            <div className="health-box" style={{ padding: '20px 0', }}>
                ...
                <div className="bmi-action">
                    <Button className="bmi-button" disabled={height <= 0 && weight <= 0} onClick={calculateBMR}>Caculate</Button>
                ...
                {
                    action && (
                        <div className="bmr-result" style={{ position: 'relative' }}>
                            <span className="health-font" style={{ fontSize: 25, fontWeight: 600 }}>Your BMR is <span className="health-font" style={{ fontSize: 25, fontWeight: 600, color: 'rgb(29, 147, 227)' }}>{result / 1000}</span> kcal</span>
                            <span className="health-font" style={{ fontSize: 18, fontWeight: 500, marginTop: 40, marginBottom: 20 }}>Daily calorie requirements for various levels of activity</span>
                            <div style={{ width: '50%' }}>
                                <Table columns={columns} dataSource={activities(result)} pagination={false} style={{ color: '#404040' }} />
                            </div>
                        </div>
                    )
                }
